...
class Category extends CI_Controller {
    ...
    public function ajax_list() {
        ...
        foreach ($list as $category) {
            ...
            $row[] = '<a class="btn btn-transparent btn-xs" href="javascript:void(0)" title="Edit" onclick="edit_category(' . "'" . $category->CategoryId . "'" . ')"><i class="fa fa-pencil"></i></a>
                  <a class="btn btn-transparent btn-xs" href="javascript:void(0)" title="Delete" onclick="delete_category(' . "'" . $category->CategoryId . "'" . ')"><i class="fa fa-times fa fa-white"></i></a>';
